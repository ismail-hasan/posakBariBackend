...
// porer request gula shei existing connection reuse korbe, r protita route
// handler nijei await kore connection ready hoyeche kina check kore nibe.
let dbPromise = null;
...
function getDB() {
      if (!dbPromise) {
            dbPromise = client.connect().then((connectedClient) => {
                  ...
                  return connectedClient.db("posakBari");
            });
      }
      return dbPromise;
}
